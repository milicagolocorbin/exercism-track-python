...
def get_leftover_of_bills(amount, denomination):
    ...
    return amount - get_value_of_bills(denomination, number_of_bills)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    maximum_value = get_number_of_bills(amount, denomination)
    return int(maximum_value * denomination)
